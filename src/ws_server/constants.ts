...
export const TYPE_ADD_SHIPS = 'add_ships';
...
export const SHIP_TYPES = [TYPE_ADD_SHIPS, TYPE_START_GAME];
export const GAME_TYPES = [TYPE_CREATE_GAME, TYPE_TURN, TYPE_ATTACK, TYPE_FINISH];
